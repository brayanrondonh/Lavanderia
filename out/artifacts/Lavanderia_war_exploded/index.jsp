                ...
                <div class="row justify-content-around align-items-center">
                    <div class="col-12 col-md-6 col-lg-3 py-3">
                        ...
                        <div class="car-body text-center my-2">
                            <a href="#" class="card-tittle h4 p-2">Caja</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 py-3">
                        <a href="#" class="menu-principal">
                        ...
                        <div class="car-body text-center my-2">
                            <a href="#" class="card-tittle h4 p-2">Consultar</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 py-3">
                        <a href="#" class="menu-principal">
                        ...
                        <div class="car-body text-center my-2">
                            <a href="#" class="card-tittle h4 p-2">Listas</a>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3 py-3">
                        <a href="index2.jsp" class="menu-principal">
                            <div class="card card-menu-principal">
                                <img src="resources/img/laundry-saloon-567951_1920.jpg" class="card-img-top img-fluid" alt="...">
                        ...
                        <div class="car-body text-center my-2">
                            <a href="index2.jsp" class="card-tittle h4 p-2">Administración</a>
                        </div>
                    </div>
                </div>
            </div>
