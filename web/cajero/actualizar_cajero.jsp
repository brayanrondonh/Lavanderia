            ...
            <div class="container">
                ...
                <form action="cajeros" method="post">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_cajero" value="${cajero.id_cajero}">
                    </div>
                    <div class="form-group">
                        <label for="dni">DNI</label>
                        <input type="text" name="dni" value="${cajero.dniCajero}" class="form-control" aria-describedby="dniHelp" placeholder="Ingresa el nombre">
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre del Cajero</label>
                        <input type="text" name="nombre" value="${cajero.nombreCajero}" class="form-control" aria-describedby="nombreHelp" placeholder="Ingresa el nombre">
                    </div>
                    <div class="form-group">
                        <label for="apellido">Apellido del Cajero</label>
                        <input type="text" name="apellido" value="${cajero.apellidoCajero}" class="form-control" aria-describedby="apellidoHelp" placeholder="Ingresa el apellido">
                    </div>
