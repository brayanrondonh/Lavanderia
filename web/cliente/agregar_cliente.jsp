            ...
            <div class="container">
                ...
                <form action="../clientes" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="correo" class="form-control" aria-describedby="dniHelp" placeholder="Ingresa el correo">
                    </div>
                    <div class="form-group">
                        <label for="telefono">Telefono del Cliente</label>
                        <input type="text" name="telefono" class="form-control" aria-describedby="dniHelp" placeholder="Ingresa el telefono">
                    </div>
