...
<body>
        ...
        <a href="cliente/agregar_cliente.jsp">Agregar Clientes</a>
        <section id="formularios" class="mx-auto">
            <div class="container">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach items="${cliente}" var="clientes"  varStatus="numero">
                        <tr>

                            <th scope="row">${numero.count}</th>
                            <td><a href="clientes?accion=consultar&idCliente=${clientes.id_cliente}">${clientes.nombre}</a></td>
